    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('download_path', models.CharField(default='downloads', max_length=512)),
                ('port', models.PositiveIntegerField(default=6102)),
                ('katomart_url', models.CharField(default='https://katomart.com', max_length=256)),
                ('JWT_SECRET_KEY', models.CharField(default='33d4498fe55a8fca179d20a4ae596fc4bf8d8fa5', max_length=64)),
                ('webui_pass', models.CharField(default='admin', max_length=128)),
                ('external_tools', models.JSONField(blank=True, default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('katomart_id', models.AutoField(primary_key=True, serialize=False)),
                ('external_id', models.CharField(blank=True, max_length=128, null=True)),
                ('extra_data', models.JSONField(blank=True, default=dict)),
                ('name', models.CharField(blank=True, max_length=256, null=True)),
                ('formatted_name', models.CharField(blank=True, max_length=256, null=True)),
